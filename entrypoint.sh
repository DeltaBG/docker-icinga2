...
export ICINGA2_FEATURE_INFLUXDB2=${ICINGA2_FEATURE_INFLUXDB2:-false}
export ICINGA2_FEATURE_INFLUXDB2_HOST=${ICINGA2_FEATURE_INFLUXDB2_HOST:-icinga-influxdb}
export ICINGA2_FEATURE_INFLUXDB2_PORT=${ICINGA2_FEATURE_INFLUXDB2_PORT:-8086}
export ICINGA2_FEATURE_INFLUXDB2_ORGANIZATION=${ICINGA2_FEATURE_INFLUXDB2_ORGANIZATION:-icinga2}
export ICINGA2_FEATURE_INFLUXDB2_BUCKET=${ICINGA2_FEATURE_INFLUXDB2_BUCKET:-icinga2}
export ICINGA2_FEATURE_INFLUXDB2_AUTH_TOKEN=${ICINGA2_FEATURE_INFLUXDB2_AUTH_TOKEN:-supersecretauthtoken}
export ICINGA2_FEATURE_INFLUXDB2_FLUSH_THRESHOLD=${ICINGA2_FEATURE_INFLUXDB2_FLUSH_THRESHOLD:-1024}
export ICINGA2_FEATURE_INFLUXDB2_FLUSH_INTERVAL=${ICINGA2_FEATURE_INFLUXDB2_FLUSH_INTERVAL:-10s}
...
/entrypoint.d/04-icinga-features/influxdb2.sh
